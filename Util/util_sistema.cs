...
namespace Util
{
    public static class util_sistema
    {
        ...
        //AGORA ESTA NO SISTEMA.UTILITARIO
        ...
        //        regkey.SetValue("lembrarSenha", util_dados.criptografar(Convert.ToString(reg.lembrarSenha)));
        //        regkey.SetValue("empresaPadrao", util_dados.criptografar(Convert.ToString(reg.empresaPadrao)));
